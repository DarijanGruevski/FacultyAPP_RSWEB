...
using FacultyApp_RSWEB.ViewModels;

namespace FacultyApp_RSWEB.Controllers
{
    public class StudentsController : Controller
    {
        private readonly FacultyApp_RSWEBContext _context;

        public StudentsController(FacultyApp_RSWEBContext context)
        {
            _context = context;
        }
