...
namespace FacultyApp_RSWEB.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(FacultyApp_RSWEBContext context)
        {
            _context = context;
        }
        ...
        {
            var facultyApp_RSWEBContext = _context.Enrollment.Include(e => e.course).Include(e => e.student);
            return View(await facultyApp_RSWEBContext.ToListAsync());
        }
